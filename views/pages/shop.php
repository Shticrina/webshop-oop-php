                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    <a class="btn hvr-hover" id="addToCartBtn<?php echo $product['id']; ?>" href="javascript:void(0)" data-slug="<?php echo $product['slug']; ?>" data-quantity="1" data-image="<?php echo $product['image']; ?>" onclick="addToCart(<?php echo $product['id']; ?>)">Add to Cart</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
